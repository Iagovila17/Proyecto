-- Insertar un usuario
INSERT INTO users (nombre, email, contraseña, direccion, telefono, rol, fechaRegistro)
VALUES ('Juan Pérez', 'juan@example.com', '123456', 'Calle Falsa 123', '123456789', 'CLIENTE', NOW());
...
-- Insertar un pedido
INSERT INTO orders (usuario_id, fecha, estado, total, metodoPago, direccionEnvio)
